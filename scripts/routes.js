  /* arr[]  ---> Input Array
    ...
    // Array to display possible combinations of token pairs
    let tokenArr=["0x5ac53f985ea80c6af769b9272f35f122201d0f56",
    ...
    // Array to display possible combinations of router pairs
    let routerArr= ["0x2CB45Edb4517d5947aFdE3BEAbF95A582506858B", 
    "0xa3a1ef5ae6561572023363862e238afa84c72ef5", 
    "0xA1B1742e9c32C7cAa9726d8204bD5715e3419861"];
    
    let r1 = routerArr.length-1;
    let r2 = tokenArr.length-1;
    let n1 = routerArr.length;
    let n2 = tokenArr.length;
    let count = 0;
